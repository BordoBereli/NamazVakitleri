...
object TileLayouts {
     ...
     * the only page shown on the tile (this Samsung watch's renderer shows a
     * single page and does not scroll between timeline entries). Full-page
     * layout so the renderer does not scale the ring down.
     */
    fun nextPrayerPage(
        scope: MaterialScope,
        data: WatchTileData,
