...
This project is indexed by GitNexus as **NamazVakitleri** (5233 symbols, 11586 relationships, 249 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
