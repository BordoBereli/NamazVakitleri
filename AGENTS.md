...
This project is indexed by GitNexus as **NamazVakitleri** (3999 symbols, 8743 relationships, 186 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
