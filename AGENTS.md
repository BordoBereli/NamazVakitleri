...
This project is indexed by GitNexus as **NamazVakitleri** (6420 symbols, 14717 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
